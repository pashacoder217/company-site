...
export default function CTASection() {
  return (
    <section className="py-20 bg-gradient-to-br from-gray-950 to-af-black relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="mb-12 alfa-card p-1">
          <LocationMap />
        </div> */}

        {/* <div className="text-center">
          <h3 className="text-2xl font-bold mb-4 text-white font-playfair">Ready to Experience af 39?</h3>
          ...
          <Button
            asChild
            size="lg"
            className="bg-af-gold text-af-black hover:bg-af-gold-light rounded-md shadow-md"
          >
