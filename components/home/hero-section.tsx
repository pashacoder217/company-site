    ...
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-studio-black/95 via-studio-black/80 to-studio-black/60"></div>
      </div>
        ...
        <div className="max-w-2xl text-white">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="text-lg px-8 py-6 text-studio-gold border-studio-gold hover:bg-studio-gold/10 rounded-md"
            >
          ...
          <div className="mt-12 flex items-center space-x-4">
            <div className="flex -space-x-2">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="w-12 h-12 rounded-full border-2 border-studio-gold overflow-hidden">
                  <Image
            ...
            <div>
              <div className="text-studio-gold flex text-2xl">{"★★★★★"}</div>
      ...
      {/* <div className="fixed bottom-24 left-6 z-40 md:block hidden">
        <Link href="/booking">
          <Button
            size="lg"
            className="bg-studio-gold text-studio-black hover:bg-studio-gold-light rounded-full shadow-xl hover:shadow-2xl transition-all duration-300 group animate-bounce hover:animate-none"
          >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-studio-black to-transparent"></div>
    </section>
  )
}
